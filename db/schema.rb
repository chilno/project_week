...
ActiveRecord::Schema.define(version: 20160630183650) do
  ...
  add_index "item_subs", ["item_id"], name: "index_item_subs_on_item_id"
  add_index "item_subs", ["sub_category_id"], name: "index_item_subs_on_sub_category_id"
